...
(((pay.employee_hours * pay.employee_salary) - pay.employee_discounts) + (pay.employee_miles_travelled * pay.employee_gas_cost)) as "employee_payslip",
 ( pay.service_billing - ((pay.employee_hours * pay.employee_salary)+((pay.employee_miles_travelled / pay.employee_car_efficiency ) * pay.employee_gas_cost)) + pay.employee_discounts ) as "employeer_profit" , pay."updatedAt" as "date" 
